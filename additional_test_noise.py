...
if __name__ == '__main__':
    ...
    for subject in subject_lst:
        ...
        trainset, trainlab, testset, testlab = form_onesub_set(subject, size=clip_length, step=clip_step, noise=noise_rate)
        ...
        tra_wtr, tes_wtr = logging_Initiation("subject{}_".format(subject, test_size),
                                              logroot='./log/public_eachsub_full_noi{}'.format(noise_rate))
        ...
        best_test_acc = 0
        curr_path = './saved_additional_noi{}/subject{}'.format(noise_rate, subject)
