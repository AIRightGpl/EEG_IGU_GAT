...
if __name__ == '__main__':
    ...
    tra_wtr, tes_wtr = logging_Initiation("cross_subject_self", logroot='./log/self_multi_rg')
    ...
    curr_path = './saved_self_multi_rg/tra' + ''.join(list(map(lambda x: str(x), trai_sub_list))) + 'tes' + ''.join(
